...
async def create_user_settings(db: AsyncSession, user_id: int, settings_data: dict) -> UserSettings:
...
async def update_user_settings(db: AsyncSession, settings: UserSettings, update_data: dict) -> UserSettings:
