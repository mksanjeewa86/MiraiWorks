...
function EditCompanyContent() {
  ...
  const t = useTranslations('companies.editCompany');
  const tAdd = useTranslations('companies.addCompany');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showToast({
        ...
        message: t('success.message', { name: formData.name }),
      });
      router.push(ROUTES.COMPANIES.BASE);
    } catch (err) {
  ...
  const handleDeactivate = async () => {
    ...
    try {
      ...
      showToast({
        type: 'success',
        title: t('success.deactivateTitle'),
        message: t('success.deactivateMessage', { name: company.name }),
      });
      router.push(ROUTES.COMPANIES.BASE);
    } catch (err) {
      setError(err instanceof Error ? err.message : t('error.deactivate'));
      setSubmitting(false);
    }
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      showToast({
        ...
        message: t('success.deleteMessage', { name: company.name }),
      });
      router.push(ROUTES.COMPANIES.BASE);
    } catch (err) {
      ...
      <AppLayout>
        <div className="flex items-center justify-center min-h-96">
          <div className="text-center">
            <div className="text-red-600 dark:text-red-400 mb-4">{t('notFound')}</div>
            <button
              onClick={() => router.push(ROUTES.COMPANIES.BASE)}
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center mb-6">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">{t('subtitle', { name: company.name })}</p>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder={tAdd('companyNamePlaceholder')}
                />
              </div>
              ...
              <div>
                ...
                >
                  <option value="employer">{tAdd('typeEmployer')}</option>
                  <option value="recruiter">{tAdd('typeRecruiter')}</option>
                </select>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                  placeholder={tAdd('websitePlaceholder')}
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                  placeholder={tAdd('postalCodePlaceholder')}
                  maxLength={8}
                />
              </div>
              ...
              <div className="relative" ref={prefectureDropdownRef}>
                ...
                >
                  {formData.prefecture || tAdd('prefectureSelect')}
                </button>
                {showPrefectureDropdown && (
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                  placeholder={tAdd('cityPlaceholder')}
                />
              </div>
            </div>
            ...
            <div className="flex items-center justify-between pt-6 border-t border-gray-200 dark:border-gray-700">
              ...
              <div className="flex space-x-3">
                ...
                >
                  ...
                  <span>{submitting ? t('updating') : t('updateButton')}</span>
                </button>
              </div>
            </div>
          </form>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-md mx-4">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                {t('deleteModal.message', { name: company?.name })}
              </p>
              <div className="flex justify-end space-x-3">
                ...
                >
                  {submitting ? t('deleteModal.deleting') : t('deleteModal.confirmButton')}
                </button>
              </div>
            </div>
          </div>
        ...
        {showDeactivateModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-md mx-4">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                {t('deactivateModal.message', { name: company?.name })}
              </p>
              <div className="flex justify-end space-x-3">
                <button
                ...
                >
                  {submitting ? t('deactivateModal.deactivating') : t('deactivateModal.confirmButton')}
                </button>
              </div>
            </div>
          </div>
