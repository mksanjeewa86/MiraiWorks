      ...
      <div className="p-4 border-t border-gray-200">
        <div className="flex space-x-2">
          <Input
            ...
            maxLength={500}
          />
          <Button onClick={handleSendMessage} disabled={!messageText.trim()} className="px-3">
            <PaperAirplaneIcon className="h-4 w-4" />
          </Button>
        </div>

        {/* Character Count */}
        <div className="text-xs text-gray-500 mt-1 text-right">{messageText.length}/500</div>
