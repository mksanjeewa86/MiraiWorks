...
def upgrade() -> None:
    ...
    op.alter_column('todos', 'assignment_status',
    ...
    op.create_foreign_key('fk_todos_assignee_id', 'todos', 'users', ['assignee_id'], ['id'], ondelete='SET NULL')
...
def downgrade() -> None:
    ...
    op.alter_column('todos', 'visibility_status',
