...
def upgrade() -> None:
    ...
    op.alter_column('todos', 'notes', new_column_name='assignee_memo', existing_type=sa.Text(), existing_nullable=True)
...
def downgrade() -> None:
    ...
    op.alter_column('todos', 'assignee_memo', new_column_name='notes', existing_type=sa.Text(), existing_nullable=True)