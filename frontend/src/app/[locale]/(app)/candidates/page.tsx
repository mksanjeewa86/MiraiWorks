...
function CandidatesPageContent() {
  ...
  const handleDelete = async (id: number) => {
    if (window.confirm(t('confirmations.deleteCandidate'))) {
      try {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div className="bg-white rounded-lg shadow-sm p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-500">{t('stats.totalCandidates')}</p>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-500">{t('stats.interviewing')}</p>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-500">{t('stats.hired')}</p>
                  <p className="text-2xl font-bold text-gray-900">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-500">{t('stats.thisMonth')}</p>
                  <p className="text-2xl font-bold text-gray-900">
                    {
                      candidates.filter((c) => {
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
              ...
              >
                <option value="all">{t('statusOptions.allStatuses')}</option>
                <option value="active">{t('statusOptions.active')}</option>
                <option value="interviewing">{t('statusOptions.interviewing')}</option>
                <option value="hired">{t('statusOptions.hired')}</option>
              ...
              >
                <option value="all">{t('sourceOptions.allSources')}</option>
                <option value="website">{t('sourceOptions.website')}</option>
                <option value="referral">{t('sourceOptions.referral')}</option>
                <option value="linkedin">{t('sourceOptions.linkedin')}</option>
                <option value="agency">{t('sourceOptions.agency')}</option>
              ...
              >
                <option value="all">{t('experienceOptions.allExperience')}</option>
                <option value="entry">{t('experienceOptions.entry')}</option>
                <option value="mid">{t('experienceOptions.mid')}</option>
                <option value="senior">{t('experienceOptions.senior')}</option>
              </select>
              ...
              >
                <option value="last_activity_desc">{t('sortOptions.recentActivity')}</option>
                <option value="created_at_desc">{t('sortOptions.newestFirst')}</option>
                <option value="created_at_asc">{t('sortOptions.oldestFirst')}</option>
                <option value="name_asc">{t('sortOptions.nameAZ')}</option>
                <option value="name_desc">{t('sortOptions.nameZA')}</option>
                <option value="rating_desc">{t('sortOptions.highestRated')}</option>
              </select>
            </div>
          </div>
          ...
          <div className="mb-4">
            <p className="text-gray-600">
              {t('results.showing', {
                start: startIndex + 1,
                end: Math.min(startIndex + paginatedCandidates.length, startIndex + itemsPerPage),
                total: totalCandidates
              })}
              {filteredCandidates.length !== candidates.length && (
                <span className="text-gray-500"> {t('results.filteredFrom', { total: candidates.length })}</span>
              )}
            </p>
          </div>
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                        {t('table.contactLocation')}
                      </th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                        {t('table.experienceSkills')}
                      </th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                        {t('table.statusRating')}
                      </th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                        {t('table.sourceActivity')}
                      </th>
                      ...
                      <tr key={candidate.id} className="hover:bg-gray-50">
                          ...
                          <div className="flex items-center">
                            ...
                            <div className="ml-4">
                              ...
                              <div className="text-sm text-gray-500">
                                {candidate.title} {candidate.company && `${t('table.at')} ${candidate.company}`}
                              </div>
                            </div>
                          </div>
                        </td>
                        ...
                        <td className="px-6 py-4">
                          <div className="text-sm text-gray-900">
                            {t('table.yearsExperience', { years: candidate.experience_years ?? 0 })}
                          </div>
                          <div className="flex flex-wrap gap-1 mt-2">
                            ...
                            {candidate.skills.length > 3 && (
                              <span className="px-2 py-1 text-xs bg-gray-100 text-gray-600 rounded-full">
                                {t('table.moreSkills', { count: candidate.skills.length - 3 })}
                              </span>
                            )}
                          </div>
                        </td>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                          <div className="flex justify-end gap-2">
                            ...
                            <Link
                              ...
                              title={t('tooltips.editCandidate')}
                            >
                              <Edit size={16} />
                            </Link>
                            ...
                            <button
                              ...
                              title={t('tooltips.deleteCandidate')}
                            >
                              <Trash2 size={16} />
                            </button>
                          </div>
