...
class MicrosoftCalendarService:
    ...
    def __init__(self):
        ...
        self.redirect_uri = f"{settings.app_base_url}/api/calendar/oauth/microsoft/callback"
        
        # Microsoft Graph endpoints
        self.oauth_url = "https://login.microsoftonline.com/common/oauth2/v2.0/authorize"
    ...
    async def get_events(
        ...
        if calendar_id:
            calendar_endpoint = f"{self.graph_api_base}/me/calendars/{calendar_id}/events"
    ...
    async def update_event(
        ...
        if calendar_id:
            calendar_endpoint = f"{self.graph_api_base}/me/calendars/{calendar_id}/events/{event_id}"
