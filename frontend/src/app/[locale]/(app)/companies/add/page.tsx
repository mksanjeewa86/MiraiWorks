...
function AddCompanyContent() {
  ...
  const t = useTranslations('companies.addCompany');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showToast({
        ...
        message: t('success.message', { name: formData.name, email: formData.email }),
      });
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value="recruiter">{t('typeRecruiter')}</option>
                </select>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="relative" ref={prefectureDropdownRef}>
                ...
                >
                  {formData.prefecture || t('prefectureSelect')}
                </button>
                {showPrefectureDropdown && (
            ...
            <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-medium text-gray-900 dark:text-white">{t('subscriptionSettings')}</h3>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  >
                    <option value="">{t('subscriptionPlanAuto')}</option>
                    {plans.map((plan) => (
                  ...
                  <div className="bg-amber-50 dark:bg-amber-900/20 p-4 rounded-lg border border-amber-200 dark:border-amber-800">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                        placeholder={t('trialPeriodPlaceholder')}
                      />
                      <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        {t('trialPeriodHelp')}
                      </p>
            ...
            <div className="flex items-center justify-end space-x-3 pt-6 border-t border-gray-200 dark:border-gray-700">
              ...
              >
                ...
                <span>{submitting ? t('submitCreating') : t('submitButton')}</span>
              </button>
            </div>
          </form>
        </div>
