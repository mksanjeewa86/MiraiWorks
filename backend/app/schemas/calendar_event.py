...
class RecurrencePattern(BaseModel):
    ...
    by_weekday: Optional[list[int]] = Field(None, description="0=Monday, 6=Sunday")
    by_monthday: Optional[list[int]] = Field(None, description="1-31")
    by_month: Optional[list[int]] = Field(None, description="1-12")
