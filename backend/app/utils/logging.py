...
def configure_structlog(
    ...
    formatter = structlog.stdlib.ProcessorFormatter(
        processor=structlog.dev.ConsoleRenderer(colors=False) if not json_logs 
...
def log_api_request(logger: FilteringBoundLogger, method: str, path: str, 
                   user_id: int = None, ip: str = None) -> None:
...
def log_api_response(logger: FilteringBoundLogger, method: str, path: str, 
                    status_code: int, duration_ms: float = None) -> None:
...
def log_db_query(logger: FilteringBoundLogger, query: str, 
                duration_ms: float = None, rows_affected: int = None) -> None:
...
def log_error(logger: FilteringBoundLogger, error: Exception, 
             context: str = None, **kwargs: Any) -> None:
