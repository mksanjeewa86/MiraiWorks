...
def downgrade() -> None:
    ...
    op.add_column('todos', sa.Column('visibility', sa.String(length=20), nullable=False, server_default='private'))
    ...
    op.create_foreign_key('fk_todos_assigned_user_id', 'todos', 'users', ['assigned_user_id'], ['id'], ondelete='SET NULL')