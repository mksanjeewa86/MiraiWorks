...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_todo_attachments_uploaded_by'), 'todo_attachments', ['uploaded_by'], unique=False)
    op.create_index(op.f('ix_todo_attachments_mime_type'), 'todo_attachments', ['mime_type'], unique=False)
    op.create_index(op.f('ix_todo_attachments_file_size'), 'todo_attachments', ['file_size'], unique=False)
