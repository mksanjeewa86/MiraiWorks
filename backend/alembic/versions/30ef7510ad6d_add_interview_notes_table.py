...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_interview_notes_id"), "interview_notes", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_interview_notes_interview_id"),
        "interview_notes",
        ["interview_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_interview_notes_participant_id"),
        "interview_notes",
        ["participant_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_interview_notes_participant_id"), table_name="interview_notes"
    )
