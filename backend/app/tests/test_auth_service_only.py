...
class TestAuthService:
    ...
    def test_decode_token_success(self, mock_decode):
        ...
        auth_service = AuthService()
        mock_decode.return_value = {"sub": "test@example.com", "exp": datetime.utcnow() + timedelta(hours=1)}
...
class TestTokenSecurity:
    ...
    def test_access_token_expiration_claim(self):
        ...
        with patch('app.services.auth_service.datetime') as mock_datetime:
            ...
            mock_datetime.side_effect = lambda *args, **kw: datetime(*args, **kw)  # Pass through constructor
