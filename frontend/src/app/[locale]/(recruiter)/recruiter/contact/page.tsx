        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="animate-slide-in-left">
              ...
              {/* FAQ Section */}
              <div className="mt-16">
                <h3 className="text-3xl font-bold text-gray-900 mb-8 bg-gradient-to-r from-gray-900 to-gray-600 bg-clip-text text-transparent">
                ...
                <div className="space-y-4">
                  <details className="group">
                    ...
                    <div className="mt-4 p-6 bg-white rounded-2xl border border-gray-100 shadow-sm">
                      <p className="text-gray-600 leading-relaxed">
                        Simply create an employer account, fill out your job details, and publish.
                        Your job will be visible to thousands of qualified candidates immediately.
                      </p>
                    </div>
                  </details>
                  ...
                  <details className="group">
                    ...
                    <div className="mt-4 p-6 bg-white rounded-2xl border border-gray-100 shadow-sm">
                      <p className="text-gray-600 leading-relaxed">
                        Yes! Creating a profile, browsing jobs, and applying is completely free for
                        job seekers. We make money from employers who post jobs.
                      </p>
                    </div>
                  </details>
                  ...
                  <details className="group">
                    ...
                    <div className="mt-4 p-6 bg-white rounded-2xl border border-gray-100 shadow-sm">
                      <p className="text-gray-600 leading-relaxed">
                        Our AI analyzes your skills, experience, preferences, and career goals to
                        match you with relevant opportunities. The more complete your profile, the
                        better the matches.
                      </p>
                    </div>
                  </details>
