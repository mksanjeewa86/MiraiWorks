  ...
  return (
    <WebsiteLayout>
      ...
      <section className="py-24 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="inline-block px-4 py-2 text-sm font-semibold text-green-600 bg-green-100 rounded-full mb-6">
              Pricing Plans
            </span>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Simple, Transparent
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Choose the plan that&apos;s right for your career or business goals
            </p>
          </div>
                ...
                <div className={`relative rounded-3xl overflow-hidden shadow-xl border transition-all duration-500 transform group-hover:-translate-y-2 ${
                  ...
                  <div className="p-8">
                    ...
                    <Link
                      ...
                      className={`group/btn block w-full text-center px-6 py-4 font-bold rounded-2xl transition-all duration-300 transform hover:scale-105 shadow-lg ${
                        plan.popular
