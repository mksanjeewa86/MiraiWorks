...
from app.schemas.recruitment_workflow.enums import CandidateWorkflowStatus, FinalResult
from app.schemas.recruitment_workflow.workflow_node_execution import WorkflowNodeExecutionInfo
...
class CandidateWorkflowStatusChange(BaseModel):
...
class CandidateWorkflowInfo(CandidateWorkflowBase):
...
class CandidateWorkflowDetails(CandidateWorkflowInfo):
    """Detailed schema for candidate process with executions"""

    executions: list[WorkflowNodeExecutionInfo] = Field(
...
class CandidateTimeline(BaseModel):
    ...
    candidate_name: str
    process_name: str
    current_status: CandidateWorkflowStatus
...
class CandidateWorkflowStart(BaseModel):
...
class CandidateWorkflowCompletion(BaseModel):
...
class CandidateWorkflowFailure(BaseModel):
...
class CandidateWorkflowStatistics(BaseModel):
