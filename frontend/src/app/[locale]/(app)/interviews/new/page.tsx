...
function ScheduleInterviewContent() {
    ...
    const fetchCandidates = async () => {
      try {
        ...
        showToast({
          type: 'error',
          title: t('error.title'),
          message: t('errors.candidatesLoadFailed'),
        });
      } finally {
  ...
  const handleCandidateSelect = (candidate: UserManagement) => {
    setFormData((prev) => ({ ...prev, assignee_id: candidate.id.toString() }));
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.assignee_id) {
      newErrors.assignee_id = t('validation.candidateRequired');
    }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                {candidates.length === 0 && !candidatesLoading && (
                  <p className="mt-1 text-sm text-yellow-600">{t('noActiveCandidates')}</p>
                )}
              </div>
                ...
                <div className="space-y-4">
                        ...
                        >
                          <div className="flex items-center">
                            ...
                            <div className="ml-3">
                              ...
                              <p className="text-xs text-gray-500">{t('systemGeneratedDesc')}</p>
                            </div>
                          </div>
                        </div>
                      </label>
                      ...
                      <label className="relative">
                        ...
                        >
                          <div className="flex items-center">
                            ...
                            <div className="ml-3">
                              <p className="text-sm font-medium text-gray-900">{t('customUrl')}</p>
                              <p className="text-xs text-gray-500">{t('customUrlDesc')}</p>
                            </div>
                          </div>
                        </div>
                      </label>
                  ...
                  {formData.video_call_type === 'custom_url' && (
                    <div>
                      ...
                      <p className="mt-1 text-xs text-gray-500">{t('meetingUrlHelper')}</p>
                    </div>
                  )}
                  ...
                  {formData.video_call_type === 'system_generated' && (
                    <div className="bg-white border border-gray-200 rounded-lg p-4">
                      <div className="flex items-start">
                        ...
                        <div className="ml-3">
                          <h4 className="text-sm font-medium text-gray-900">{t('autoGenTitle')}</h4>
                          <p className="text-sm text-gray-600 mt-1">{t('autoGenDesc')}</p>
                          <div className="mt-2 text-xs text-gray-500">{t('autoGenFeatures')}</div>
                        </div>
                      </div>
                    </div>
                  )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <DatePicker
                  ...
                  timeIntervals={15}
                  dateFormat="yyyy-MM-dd HH:mm"
                  placeholderText={t('endTimePlaceholder')}
                  className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${
