...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_connection_invitations_id"),
        "connection_invitations",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_connection_invitations_receiver_id"),
        "connection_invitations",
        ["receiver_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_connection_invitations_sender_id"),
        "connection_invitations",
        ["sender_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_connection_invitations_status"),
        "connection_invitations",
        ["status"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_connection_invitations_status"), table_name="connection_invitations"
    )
    op.drop_index(
        op.f("ix_connection_invitations_sender_id"), table_name="connection_invitations"
    )
    op.drop_index(
        op.f("ix_connection_invitations_receiver_id"),
    ...
    op.drop_index(
        op.f("ix_connection_invitations_id"), table_name="connection_invitations"
    )
