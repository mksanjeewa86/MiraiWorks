...
def upgrade() -> None:
    # Add file attachment columns to direct_messages table
    op.add_column('direct_messages', sa.Column('file_url', sa.String(500), nullable=True))
    ...
    op.add_column('direct_messages', sa.Column('file_type', sa.String(100), nullable=True))
