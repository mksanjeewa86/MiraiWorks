...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_system_updates_is_active'), 'system_updates', ['is_active'], unique=False)
    op.create_index(op.f('ix_system_updates_created_at'), 'system_updates', ['created_at'], unique=False)
