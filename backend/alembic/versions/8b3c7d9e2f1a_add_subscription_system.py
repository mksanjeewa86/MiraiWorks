...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_features_parent_feature_id'), 'features', ['parent_feature_id'], unique=False)
    op.create_index(op.f('ix_features_permission_key'), 'features', ['permission_key'], unique=False)
    op.create_index(op.f('ix_features_category'), 'features', ['category'], unique=False)
    op.create_index(op.f('ix_features_is_active'), 'features', ['is_active'], unique=False)
    ...
    op.create_index(op.f('ix_company_subscriptions_is_active'), 'company_subscriptions', ['is_active'], unique=False)
    ...
    op.create_index(op.f('ix_plan_change_requests_company_id'), 'plan_change_requests', ['company_id'], unique=False)
    op.create_index(op.f('ix_plan_change_requests_subscription_id'), 'plan_change_requests', ['subscription_id'], unique=False)
    op.create_index(op.f('ix_plan_change_requests_request_type'), 'plan_change_requests', ['request_type'], unique=False)
    op.create_index(op.f('ix_plan_change_requests_status'), 'plan_change_requests', ['status'], unique=False)
