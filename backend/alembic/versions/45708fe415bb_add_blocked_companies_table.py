...
def upgrade() -> None:
    ...
    # Create indexes
    op.create_index(
        "ix_blocked_companies_user_id", "blocked_companies", ["user_id"], unique=False
    )
    op.create_index(
        "ix_blocked_companies_company_id",
        "blocked_companies",
        ["company_id"],
        unique=False,
    )
    op.create_index(
        "ix_blocked_companies_company_name",
        "blocked_companies",
        ["company_name"],
        unique=False,
    )
    op.create_index(
        "ix_blocked_companies_user_company",
        "blocked_companies",
        ["user_id", "company_id"],
        unique=True,
    )
