...
export default function DemoExamPage() {
  const [selectedExamType, setSelectedExamType] = useState<string>("aptitude");

  const demoExams = [
    {
      id: "demo-aptitude",
      title: "適性検査 Demo (Aptitude Test)",
      description: "Experience a sample aptitude test with various question types including logical reasoning, numerical analysis, and language comprehension.",
      exam_type: "aptitude",
    ...
    },
    {
      ...
      description: "Practice with programming and technical questions to understand the format of skill-based assessments.",
      exam_type: "skill",
    ...
    },
    {
      ...
      description: "Sample personality and behavioral assessment to help you understand what employers might evaluate.",
    ...
    <div className="container mx-auto py-6 px-4 max-w-6xl">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          Get familiar with our exam platform by taking these practice tests. 
          Experience different question types and features before taking your actual recruitment exam.
        </p>
      </div>
      ...
      <Alert className="mb-8 bg-blue-50 border-blue-200">
        ...
        <AlertDescription className="text-blue-800">
          <strong>Why take practice exams?</strong> Familiarize yourself with the interface, understand different question types, 
          practice time management, and reduce test anxiety. These demo exams don't affect your actual results.
        </AlertDescription>
      </Alert>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className={getDifficultyColor(exam.difficulty)}>
                    {exam.difficulty}
                  </span>
                </div>
          ...
          <CardContent className="space-y-3">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-gray-600">Experience how tab switching is detected</div>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-gray-600">Answers are automatically saved as you type</div>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <div className="grid gap-3 md:grid-cols-2">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-green-700">Find a quiet space with stable internet connection</div>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-green-700">Take time to understand each question type</div>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-green-700">Keep an eye on the timer and pace yourself</div>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-green-700">Avoid switching tabs or opening other applications</div>
              </div>
            </div>
          </div>
        </CardContent>
