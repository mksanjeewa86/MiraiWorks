...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_video_calls_candidate_id'), 'video_calls', ['candidate_id'], unique=False)
    op.create_index(op.f('ix_video_calls_id'), 'video_calls', ['id'], unique=False)
    op.create_index(op.f('ix_video_calls_interview_id'), 'video_calls', ['interview_id'], unique=False)
    op.create_index(op.f('ix_video_calls_interviewer_id'), 'video_calls', ['interviewer_id'], unique=False)
    ...
    op.create_table('call_participants',
        ...
        sa.ForeignKeyConstraint(['video_call_id'], ['video_calls.id'], ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_index(op.f('ix_recording_consents_id'), 'recording_consents', ['id'], unique=False)
    ...
    op.create_index(op.f('ix_transcription_segments_speaker_id'), 'transcription_segments', ['speaker_id'], unique=False)
    op.create_index(op.f('ix_transcription_segments_video_call_id'), 'transcription_segments', ['video_call_id'], unique=False)
    op.create_index('idx_transcription_segments_video_call_time', 'transcription_segments', ['video_call_id', 'start_time'], unique=False)


def downgrade() -> None:
    # Drop tables in reverse order
    op.drop_index('idx_transcription_segments_video_call_time', table_name='transcription_segments')
    op.drop_index(op.f('ix_transcription_segments_video_call_id'), table_name='transcription_segments')
