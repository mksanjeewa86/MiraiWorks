...
@pytest.mark.asyncio
async def test_login_inactive_user(client: AsyncClient, test_user: User, db_session: AsyncSession):
...
@pytest.mark.asyncio
async def test_login_with_role_eager_loading(client: AsyncClient, test_admin_user: User, db_session):
