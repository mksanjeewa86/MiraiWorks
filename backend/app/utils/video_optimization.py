...
class VideoCallOptimizer:
    ...
    async def optimize_database_performance(self, db: AsyncSession) -> Dict[str, Any]:
        ...
        try:
            ...
            cutoff_date = datetime.now(timezone.utc) - self.old_calls_threshold
    ...
    async def optimize_transcription_performance(self, db: AsyncSession) -> Dict[str, Any]:
        ...
        try:
            ...
            for segment in segments_to_process:
                ...
                segment.processed_at = datetime.now(timezone.utc)
    ...
    async def cleanup_inactive_sessions(self, db: AsyncSession) -> int:
        ...
        try:
            ...
            timeout_threshold = datetime.now(timezone.utc) - timedelta(hours=2)
