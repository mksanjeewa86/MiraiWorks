...
def upgrade() -> None:
    ...
    op.add_column(
        "todo_attachments", sa.Column("deleted_by", sa.Integer(), nullable=True)
    )
    op.create_index(
        op.f("ix_todo_attachments_is_deleted"),
        "todo_attachments",
        ["is_deleted"],
        unique=False,
    )
    op.create_foreign_key(
        "fk_todo_attachments_deleted_by",
        "todo_attachments",
        "users",
        ["deleted_by"],
        ["id"],
    ...
    op.add_column(
        "todo_extension_requests", sa.Column("deleted_by", sa.Integer(), nullable=True)
    )
    op.create_index(
        op.f("ix_todo_extension_requests_is_deleted"),
        "todo_extension_requests",
        ["is_deleted"],
        unique=False,
    )
    op.create_foreign_key(
        "fk_todo_extension_requests_deleted_by",
        "todo_extension_requests",
        "users",
        ["deleted_by"],
        ["id"],
    ...
    if "todo_viewers" in inspector.get_table_names():
        ...
        op.add_column(
            "todo_viewers", sa.Column("deleted_by", sa.Integer(), nullable=True)
        )
        op.create_index(
            op.f("ix_todo_viewers_is_deleted"),
            "todo_viewers",
            ["is_deleted"],
            unique=False,
        )
        op.create_foreign_key(
            "fk_todo_viewers_deleted_by",
            "todo_viewers",
            "users",
            ["deleted_by"],
            ["id"],
    ...
    if "todo_viewer_memos" in inspector.get_table_names():
        ...
        op.add_column(
            "todo_viewer_memos", sa.Column("deleted_by", sa.Integer(), nullable=True)
        )
        op.create_index(
            op.f("ix_todo_viewer_memos_is_deleted"),
            "todo_viewer_memos",
            ["is_deleted"],
            unique=False,
        )
        op.create_foreign_key(
            "fk_todo_viewer_memos_deleted_by",
            "todo_viewer_memos",
            "users",
            ["deleted_by"],
            ["id"],
...
def downgrade() -> None:
    ...
    if "todo_viewer_memos" in inspector.get_table_names():
        op.drop_constraint(
            "fk_todo_viewer_memos_deleted_by", "todo_viewer_memos", type_="foreignkey"
        )
        op.drop_index(
            op.f("ix_todo_viewer_memos_is_deleted"), table_name="todo_viewer_memos"
        )
    ...
    if "todo_viewers" in inspector.get_table_names():
        op.drop_constraint(
            "fk_todo_viewers_deleted_by", "todo_viewers", type_="foreignkey"
        )
    ...
    op.drop_index(
        op.f("ix_todo_extension_requests_is_deleted"),
        table_name="todo_extension_requests",
    )
    ...
    op.drop_constraint(
        "fk_todo_attachments_deleted_by", "todo_attachments", type_="foreignkey"
    )
