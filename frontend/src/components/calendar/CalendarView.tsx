      ...
      <div className="flex items-center justify-between px-8 py-5 border-b border-gray-100 bg-gray-50/50">
        <div className="flex items-center space-x-6">
          ...
          <h2 className="text-2xl font-semibold text-gray-900">
            ...
            {viewType === 'week' && `Week of ${calendarData.days[0].toLocaleDateString('en-US', { month: 'short', day: 'numeric' })}`}
          ...
          <div className="min-h-full bg-white">
            ...
            <div className="grid grid-cols-7 border-b border-gray-100 bg-gray-50/30">
              {['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'].map(day => (
                <div key={day} className="p-4 text-xs font-semibold text-gray-600 text-center uppercase tracking-wider">
                  {day.slice(0, 3)}
                </div>
              ))}
            </div>
                  ...
                  return (
                    <div
                      ...
                      className={`border-r border-b border-gray-100 p-3 cursor-pointer transition-all duration-200 ${
                        isCurrentMonthDate ? 'bg-white hover:bg-gray-50/80' : 'bg-gray-50/50 text-gray-400'
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        <span className={`text-sm font-semibold transition-colors ${
                          isTodayDate ? 'text-blue-600 bg-blue-100 w-7 h-7 rounded-full flex items-center justify-center' :
                  ...
                  {calendarData.days.map((date, dayIndex) => {
                    ...
                    return (
                      <div
                        ...
                        onClick={() => canCreateEvents && onDateSelect(new Date(date.setHours(hour)))}
                      >
                ...
                return (
                  <div key={hour} className="flex min-h-[80px] border-b border-gray-100">
                    ...
                    <div
                      ...
                      onClick={() => canCreateEvents && onDateSelect(new Date(currentDate.setHours(hour)))}
                    >
