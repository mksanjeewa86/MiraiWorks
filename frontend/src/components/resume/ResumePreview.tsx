...
export default function ResumePreview({
  ...
  const [showPreviewControls, setShowPreviewControls] = useState(showControls);
  ...
  }, [isFullscreen, zoomLevel, showPreviewControls]);
        ...
        <div className={`bg-white ${isFullscreen ? 'h-screen overflow-auto' : ''}`}>
          {loading ? (
            ...
            <div className="p-12 text-center">
              ...
              <p className="text-gray-600">Unable to generate resume preview</p>
            </div>
          )}
        </div>
      </Card>
