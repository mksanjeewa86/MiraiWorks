...
down_revision: str | None = "add_holidays_table"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["parent_event_id"], ["calendar_events.id"], ondelete="CASCADE"
        ),
    )

    # Create indexes for better query performance
    op.create_index(
        "idx_calendar_events_start_datetime", "calendar_events", ["start_datetime"]
    )
