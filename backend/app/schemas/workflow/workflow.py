...
class WorkflowDetails(WorkflowInfo):
    """Detailed schema for recruitment process with relationships"""

    nodes: list[WorkflowNodeInfo] = Field(default_factory=list)
    candidate_workflows: list[CandidateWorkflowInfo] = Field(default_factory=list)
