...
class Conversation(Base):
    ...
    type = Column(String(50), nullable=False, default="direct", index=True)  # direct, group, support
...
class Message(Base):
    ...
    type = Column(String(50), nullable=False, default=MessageType.TEXT.value, index=True)
...
class MessageRead(Base):
    ...
    read_at = Column(DateTime(timezone=True), server_default=func.now(), nullable=False, index=True)
