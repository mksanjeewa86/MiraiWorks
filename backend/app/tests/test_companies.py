...
class TestCompanies:
    ...
    @pytest.mark.asyncio
    async def test_get_companies_with_filters(
        self, client: AsyncClient, super_admin_auth_headers: dict
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_company_admin_status(
        self, client: AsyncClient, super_admin_auth_headers: dict, test_company: Company
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_companies_forbidden_regular_user(
    ...
    @pytest.mark.asyncio
    async def test_get_companies_forbidden_company_admin(
    ...
    @pytest.mark.asyncio
    async def test_create_company_forbidden_regular_user(
        self, client: AsyncClient, auth_headers: dict
    ):
        """Test company creation with regular user permissions."""
        company_data = {"name": "Test Company", "email": "test@example.com"}
        response = await client.post(
            "/api/admin/companies", json=company_data, headers=auth_headers
        )
        assert response.status_code == 403

    @pytest.mark.asyncio
    async def test_create_company_forbidden_company_admin(
        self, client: AsyncClient, admin_auth_headers: dict
    ):
        """Test company creation with company admin permissions."""
        company_data = {"name": "Test Company", "email": "test@example.com"}
        response = await client.post(
            "/api/admin/companies", json=company_data, headers=admin_auth_headers
        )
        assert response.status_code == 403
    ...
    @pytest.mark.asyncio
    async def test_delete_company_forbidden_non_super_admin(
        ...
        response = await client.delete(
            f"/api/admin/companies/{test_company.id}", headers=admin_auth_headers
        )
        assert response.status_code == 403
    ...
    @pytest.mark.asyncio
    async def test_create_company_invalid_email(
        self, client: AsyncClient, super_admin_auth_headers: dict
    ):
    ...
    @pytest.mark.asyncio
    async def test_create_company_duplicate_email(
        self, client: AsyncClient, super_admin_auth_headers: dict, test_company: Company
    ):
    ...
    @pytest.mark.asyncio
    async def test_create_company_invalid_type(
        self, client: AsyncClient, super_admin_auth_headers: dict
    ):
    ...
    @pytest.mark.asyncio
    async def test_update_company_invalid_data(
        self, client: AsyncClient, super_admin_auth_headers: dict, test_company: Company
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_companies_invalid_pagination(
        self, client: AsyncClient, super_admin_auth_headers: dict
    ):
        """Test companies list with invalid pagination parameters."""
        response = await client.get(
            "/api/admin/companies?page=-1&size=0", headers=super_admin_auth_headers
        )
    ...
    async def test_get_company_not_found(
        ...
        response = await client.get(
            "/api/admin/companies/99999", headers=super_admin_auth_headers
        )
    ...
    @pytest.mark.asyncio
    async def test_get_admin_status_not_found(
        self, client: AsyncClient, super_admin_auth_headers: dict
    ):
        """Test getting admin status for non-existent company."""
        response = await client.get(
            "/api/admin/companies/99999/admin-status", headers=super_admin_auth_headers
        )
        assert response.status_code == 404
    ...
    @pytest.mark.asyncio
    async def test_delete_company_with_users_forbidden(
        self,
        client: AsyncClient,
        super_admin_auth_headers: dict,
    ...
    @pytest.mark.asyncio
    async def test_create_company_creates_admin_user(
        self,
        client: AsyncClient,
        super_admin_auth_headers: dict,
        db_session: AsyncSession,
    ...
    @pytest.mark.asyncio
    async def test_create_company_with_long_name(
        self, client: AsyncClient, super_admin_auth_headers: dict
    ):
    ...
    @pytest.mark.asyncio
    async def test_update_company_to_duplicate_email(
        self,
        client: AsyncClient,
        super_admin_auth_headers: dict,
        test_company: Company,
    ...
    @pytest.mark.asyncio
    async def test_get_companies_with_complex_search(
        self, client: AsyncClient, super_admin_auth_headers: dict
    ):
    ...
    @pytest.mark.asyncio
    async def test_create_company_all_valid_types(
        self, client: AsyncClient, super_admin_auth_headers: dict
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_companies_filter_by_search_name(
        self, client: AsyncClient, super_admin_auth_headers: dict, test_company: Company
    ):
        ...
        found_company = any(
            company["id"] == test_company.id for company in data["companies"]
        )
        assert found_company is True

    @pytest.mark.asyncio
    async def test_get_companies_filter_by_search_email(
        self, client: AsyncClient, super_admin_auth_headers: dict, test_company: Company
    ):
        """Test filtering companies by search term matching email."""
        search_term = test_company.email.split("@")[
            0
    ...
    @pytest.mark.asyncio
    async def test_get_companies_search_case_insensitive(
        self, client: AsyncClient, super_admin_auth_headers: dict, test_company: Company
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_companies_filter_by_type_employer(
        self, client: AsyncClient, super_admin_auth_headers: dict
    ):
    ...
    async def test_get_companies_filter_by_is_active_true(
        ...
        response = await client.get(
            "/api/admin/companies?is_active=true", headers=super_admin_auth_headers
        )
    ...
    @pytest.mark.asyncio
    async def test_get_companies_filter_by_is_active_false(
        self,
        client: AsyncClient,
        super_admin_auth_headers: dict,
        db_session: AsyncSession,
        ...
        response = await client.get(
            "/api/admin/companies?is_active=false", headers=super_admin_auth_headers
        )
        ...
        inactive_companies = [
            company for company in data["companies"] if company["is_active"] is False
        ]
        assert len(inactive_companies) >= 1

    @pytest.mark.asyncio
    async def test_get_companies_filter_by_is_demo_true(
        self,
        client: AsyncClient,
        super_admin_auth_headers: dict,
        db_session: AsyncSession,
        ...
        response = await client.get(
            "/api/admin/companies?is_demo=true", headers=super_admin_auth_headers
        )
        ...
        demo_companies = [
            company for company in data["companies"] if company["is_demo"] is True
        ]
        assert len(demo_companies) >= 1

    @pytest.mark.asyncio
    async def test_get_companies_filter_by_is_demo_false(
        self, client: AsyncClient, super_admin_auth_headers: dict
    ):
        """Test filtering companies by is_demo=false."""
        response = await client.get(
            "/api/admin/companies?is_demo=false", headers=super_admin_auth_headers
        )
    ...
    @pytest.mark.asyncio
    async def test_get_companies_include_deleted_false_default(
        self, client: AsyncClient, super_admin_auth_headers: dict
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_companies_include_deleted_false_explicit(
        self, client: AsyncClient, super_admin_auth_headers: dict
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_companies_include_deleted_true(
        self,
        client: AsyncClient,
        super_admin_auth_headers: dict,
        test_company: "Company",
        ...
        deleted_companies = [
            company for company in data["companies"] if company["is_deleted"] is True
        ]
        non_deleted_companies = [
            company for company in data["companies"] if company["is_deleted"] is False
        ]
        assert len(deleted_companies) >= 1
        assert len(non_deleted_companies) >= 1

    @pytest.mark.asyncio
    async def test_get_companies_pagination_with_size(
        self, client: AsyncClient, super_admin_auth_headers: dict
    ):
        """Test companies pagination with specific page size."""
        response = await client.get(
            "/api/admin/companies?page=1&size=5", headers=super_admin_auth_headers
        )
    ...
    @pytest.mark.asyncio
    async def test_get_companies_pagination_multiple_pages(
        self, client: AsyncClient, super_admin_auth_headers: dict
    ):
        """Test companies pagination across multiple pages."""
        # Test first page
        response1 = await client.get(
            "/api/admin/companies?page=1&size=2", headers=super_admin_auth_headers
        )
        ...
        if data1["total"] > 2:
            response2 = await client.get(
                "/api/admin/companies?page=2&size=2", headers=super_admin_auth_headers
            )
    ...
    @pytest.mark.asyncio
    async def test_get_companies_combined_filters_type_and_active(
        self, client: AsyncClient, super_admin_auth_headers: dict
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_companies_combined_filters_search_and_type(
        self, client: AsyncClient, super_admin_auth_headers: dict
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_companies_empty_search_returns_all(
        self, client: AsyncClient, super_admin_auth_headers: dict
    ):
        """Test that empty search parameter returns all companies."""
        response = await client.get(
            "/api/admin/companies?search=", headers=super_admin_auth_headers
        )
    ...
    @pytest.mark.asyncio
    async def test_get_companies_nonexistent_search_returns_empty(
        self, client: AsyncClient, super_admin_auth_headers: dict
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_companies_filter_validation_invalid_type(
        self, client: AsyncClient, super_admin_auth_headers: dict
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_companies_pagination_boundary_conditions(
        self, client: AsyncClient, super_admin_auth_headers: dict
    ):
        """Test pagination boundary conditions."""
        # Test page beyond available results
        response = await client.get(
            "/api/admin/companies?page=1000&size=10", headers=super_admin_auth_headers
        )
    ...
    @pytest.mark.asyncio
    async def test_get_companies_filter_by_multiple_types(
        self,
        client: AsyncClient,
        super_admin_auth_headers: dict,
        db_session: AsyncSession,
    ...
    @pytest.mark.asyncio
    async def test_get_companies_deleted_field_in_response(
        self, client: AsyncClient, super_admin_auth_headers: dict
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_companies_filter_combination_with_pagination(
        self, client: AsyncClient, super_admin_auth_headers: dict
    ):
