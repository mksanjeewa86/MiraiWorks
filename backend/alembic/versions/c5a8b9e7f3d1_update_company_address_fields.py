...
down_revision: str | None = "95de50a27612"
...
def upgrade() -> None:
    ...
    if "postal_code" not in columns:
        op.add_column(
            "companies", sa.Column("postal_code", sa.String(10), nullable=True)
        )
    if "prefecture" not in columns:
        op.add_column(
            "companies", sa.Column("prefecture", sa.String(50), nullable=True)
        )
