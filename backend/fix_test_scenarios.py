...
content = re.sub(r'\s+async with AsyncClient\(app=app, base_url="http://test"\) as client:\n', '', content)

# Write back to file
with open('app/tests/test_recruitment_workflow_scenarios.py', 'w', encoding='utf-8') as file:
    file.write(content)
