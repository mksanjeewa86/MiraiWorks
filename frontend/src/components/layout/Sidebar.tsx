    ...
    <>
      ...
      >
        <div className="flex flex-col h-full relative overflow-hidden">
          ...
          <div className={`absolute inset-0 ${colorScheme.backgroundOverlay} pointer-events-none`} />
          <div className="relative z-10 flex flex-col h-full overflow-hidden">
          {/* Header */}
          <div className={`flex items-center justify-between p-4 border-b ${colorScheme.border} ${colorScheme.headerBackground}`}>
            {!isCollapsed ? (
              <>
                ...
                >
                  <div className={`w-8 h-8 rounded-lg ${colorScheme.brandBackground} flex items-center justify-center`}>
                ...
                <div className="flex items-center space-x-2">
                  {!isMobile && (
                    ...
                    >
                      <ChevronLeft className={`h-4 w-4 ${colorScheme.textSecondary} hover:${colorScheme.textPrimary} flex-shrink-0`} />
                    </button>
                  )}
                  {isMobile && (
                    <button
                    ...
                    >
                      <X className={`h-4 w-4 ${colorScheme.textSecondary} hover:${colorScheme.textPrimary}`} />
                    </button>
                  )}
                </div>
              </>
              ...
              <>
                ...
                >
                  <Menu className={`h-4 w-4 ${colorScheme.textSecondary} hover:${colorScheme.textPrimary} flex-shrink-0`} />
                </button>
              </>
            )}
          </div>
                  ...
                  >
                    ...
                    {active && !isCollapsed && (
                      <div className="ml-auto">
                        <div className={`w-2 h-2 rounded-full ${colorScheme.activeIndicator} shadow-lg ${colorScheme.activeIndicatorShadow} animate-pulse`} />
                      </div>
                    )}
                    ...
                    {!active && !isCollapsed && (
                      <div className="ml-auto opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                        <div className={`w-1.5 h-1.5 rounded-full ${colorScheme.activeIndicator}/60`} />
                      </div>
                    )}
          ...
          {isCollapsed && user && (
            <div className={`px-2 py-4 border-t ${colorScheme.border} ${colorScheme.headerBackground} flex justify-center`}>
              <div className={`w-10 h-10 rounded-full ${colorScheme.avatarBackground} flex items-center justify-center ${colorScheme.textPrimary} text-sm font-bold shadow-lg ring-2 ${colorScheme.avatarRing} flex-shrink-0`}>
          ...
          {!isCollapsed && user && (
            <div className={`p-4 border-t ${colorScheme.border} ${colorScheme.headerBackground}`}>
              <div className={`flex items-center space-x-3 p-3 rounded-xl ${colorScheme.headerBackground} border ${colorScheme.buttonBorder} ${colorScheme.buttonHover} transition-all duration-200`}>
                <div className={`w-12 h-12 rounded-full ${colorScheme.avatarBackground} flex items-center justify-center ${colorScheme.textPrimary} text-sm font-bold shadow-lg ring-2 ${colorScheme.avatarRing}`}>
                  {user.first_name?.[0] || user.email[0].toUpperCase()}
                </div>
                ...
                <div className={`w-2 h-2 rounded-full ${colorScheme.statusIndicator} shadow-lg ${colorScheme.statusIndicatorShadow} animate-pulse`} />
              </div>
            </div>
          )}
          </div>
