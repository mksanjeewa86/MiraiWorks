...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_profile_work_experiences_id"),
        "profile_work_experiences",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_profile_work_experiences_user_id"),
        "profile_work_experiences",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_profile_educations_id"), "profile_educations", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_profile_educations_user_id"),
        "profile_educations",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "endorsement_count", sa.Integer(), nullable=False, server_default="0"
        ),
        sa.Column("display_order", sa.Integer(), nullable=False, server_default="0"),
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.Column("updated_at", sa.DateTime(), nullable=True),
    ...
    op.create_index(
        op.f("ix_profile_skills_id"), "profile_skills", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_profile_skills_user_id"), "profile_skills", ["user_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_profile_certifications_id"),
        "profile_certifications",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_profile_certifications_user_id"),
        "profile_certifications",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_profile_projects_id"), "profile_projects", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_profile_projects_user_id"),
        "profile_projects",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "willing_to_relocate", sa.Boolean(), nullable=False, server_default="0"
        ),
    ...
    op.create_index(
        op.f("ix_profile_job_preferences_id"),
        "profile_job_preferences",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_profile_job_preferences_user_id"),
        "profile_job_preferences",
        ["user_id"],
        unique=True,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_profile_job_preferences_user_id"), table_name="profile_job_preferences"
    )
    op.drop_index(
        op.f("ix_profile_job_preferences_id"), table_name="profile_job_preferences"
    )
    ...
    op.drop_index(
        op.f("ix_profile_certifications_user_id"), table_name="profile_certifications"
    )
    op.drop_index(
        op.f("ix_profile_certifications_id"), table_name="profile_certifications"
    )
    ...
    op.drop_index(
        op.f("ix_profile_educations_user_id"), table_name="profile_educations"
    )
    ...
    op.drop_index(
        op.f("ix_profile_work_experiences_user_id"),
        table_name="profile_work_experiences",
    )
    op.drop_index(
        op.f("ix_profile_work_experiences_id"), table_name="profile_work_experiences"
    )
