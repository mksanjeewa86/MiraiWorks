    ...
    return (
      <div className="card p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="loading-skeleton" style={{ width: '24px', height: '24px', borderRadius: '50%' }} />
        </div>
        <div className="loading-skeleton" style={{ width: '80px', height: '32px', marginBottom: '8px' }} />
