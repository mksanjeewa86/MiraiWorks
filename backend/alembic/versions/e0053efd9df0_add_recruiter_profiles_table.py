...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_recruiter_profiles_id"), "recruiter_profiles", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_recruiter_profiles_user_id"),
        "recruiter_profiles",
        ["user_id"],
        unique=True,
    )
...
def downgrade() -> None:
    op.drop_index(
        op.f("ix_recruiter_profiles_user_id"), table_name="recruiter_profiles"
    )
