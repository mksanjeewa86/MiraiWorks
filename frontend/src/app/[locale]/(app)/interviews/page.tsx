          ...
          <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              >
                ...
                <option value="rescheduled">{t('list.rescheduled')}</option>
              </select>
              ...
              >
                ...
                <option value="in_person">{t('types.onsite')}</option>
              </select>
          ...
          <div className="mb-4">
            <p className="text-gray-600">
              {t('pagination.showing', {
                start: startIndex + 1,
                end: Math.min(startIndex + itemsPerPage, filteredInterviews.length),
              ...
              <div className="p-8 text-center">
                ...
                <p className="text-gray-600 mb-4">
                  {searchTerm || statusFilter !== 'all' || typeFilter !== 'all'
                    ...
                    : canCreateInterviews()
                      ? t('emptyState.forCreators')
                      : t('emptyState.forCandidates')}
                </p>
                {!searchTerm &&
                  statusFilter === 'all' &&
                  typeFilter === 'all' &&
                  ...
                  <thead className="bg-gray-50">
                    <tr>
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                        {t('table.headers.interviewDetails')}
                      </th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                        {t('table.headers.participants')}
                      </th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
