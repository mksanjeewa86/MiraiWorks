...
class TestDirectMessagesAPI:
    ...
    def test_get_conversations_success(
        ...
        assert user2_conversation["other_user_name"] == f"{test_user2.first_name} {test_user2.last_name}"
    ...
    def test_get_conversations_with_search(
        ...
        for conversation in conversations:
            assert "test2" in conversation["other_user_name"].lower() or \
                   "test2" in conversation["other_user_email"].lower()
    ...
    def test_mark_messages_as_read_success(
        ...
        unread_message_ids = [
            msg.id for msg in test_messages 
    ...
    def test_get_participants_role_filtering(
        ...
        participant_ids = [p["id"] for p in participants]
        assert test_user2.id not in participant_ids  # Regular user should not be visible
