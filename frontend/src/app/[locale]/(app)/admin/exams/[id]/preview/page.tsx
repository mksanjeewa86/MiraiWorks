...
export default function ExamPreviewPage() {
  ...
  const startTestExam = () => {
    ...
    router.push(withQueryParams(ROUTES.EXAMS.TAKE(examId), { mode: 'test' }));
  };
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <Button asChild>
            <Link href={ROUTES.ADMIN.EXAMS.BASE}>Back to Exams</Link>
          </Button>
        </div>
      </div>
    );
    ...
    <div className="container mx-auto py-6 px-4 max-w-6xl">
      ...
      <div className="flex items-center gap-4 mb-6">
        <Button variant="outline" asChild>
          <Link href={ROUTES.ADMIN.EXAMS.BASE}>
        ...
        <div className="flex gap-3">
          ...
          <Button asChild variant="outline">
            <Link href={ROUTES.ADMIN.EXAMS.EDIT(examId)}>
        ...
        <Alert className="mb-6">
          ...
          <AlertDescription>
            ...
            {examInfo.status === 'draft' &&
              ' It needs to be activated before candidates can take it.'}
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div>
                  ...
                  <div className="text-gray-900">
                    {new Date(examInfo.created_at).toLocaleDateString()}
                  </div>
                </div>
              </div>
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    {examInfo.time_limit_minutes
                      ? `${examInfo.time_limit_minutes} minutes`
                      : 'No limit'}
                  </span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="space-y-3">
                  ...
                  {examInfo.require_face_verification && (
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">
                        {examInfo.face_check_interval_minutes} minutes
                      </span>
                    </div>
                  )}
                </div>
          ...
          {questions.length === 0 ? (
            <Card>
              <CardContent className="p-8 text-center">
                ...
                <Button asChild>
                  <Link href={ROUTES.ADMIN.EXAMS.EDIT(examId)}>Add Questions</Link>
                </Button>
              </CardContent>
            </Card>
          ) : (
            questions.map((question, index) => (
              <Card key={question.id}>
                <CardHeader>
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <CardDescription>
                        {getQuestionTypeLabel(question.question_type)} • {question.points}{' '}
                        {question.points === 1 ? 'point' : 'points'}
                        {question.time_limit_seconds &&
                          ` • ${Math.floor(question.time_limit_seconds / 60)}m limit`}
                      </CardDescription>
                    </div>
                ...
                <CardContent className="space-y-4">
                  ...
                  {/* Text Limits */}
                  {[QuestionType.TEXT_INPUT, QuestionType.ESSAY].includes(
      ...
      <Card className="mt-8 bg-blue-50 border-blue-200">
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-lg font-semibold text-blue-900 mb-2">Ready to test this exam?</h3>
              <p className="text-blue-700">
                Take a test run to experience the exam from a candidate's perspective. Test sessions
                don't count towards statistics and are marked as practice.
              </p>
            </div>
